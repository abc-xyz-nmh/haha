...
getgenv().gagConfig = {
    ...
    BUY_TRAVELING_MERCHANT = { "Bee Egg", "Loquat", "Feijoa", "Pitcher Plant", "Paradise Egg" },
    MAX_EVENT_RESTOCK_SHECKLES = 1_000_000_000_000,  -- Restock stop at 48m
    BUY_EVENT_SHOP = { "Sprout Seed Pack", "Sprout Egg", "Skyroot Chest", "Gnome" },
    ...
    KEEP_PETS = { "Gnome", "Green Bean", "Apple Gazelle", "Lemon Lion", "Peach Wasp", "Griffin", "Golden Goose", "Golem", "Seedling", "Junkbot", "Lobster Thermidor", "French Fry Ferret", "Corrupted Kitsune", "Raiju", "Mizuchi", "Kitsune", "Koi", "Bald Eagle", "Ankylosaurus", "Spinosaurus", "Brontosaurus", "T-Rex", "Seal", "Fennec Fox", "Disco Bee", "Raccoon", "Queen Bee", "Night Owl", "Dragonfly", "Butterfly", "Mimic Octopus", "Red Fox", "Hyacinth Macaw", "Pack Bee", "Petal Bee", "Bear Bee", "Hamster", "Blood Owl", "Cooked Owl", "Golden Bee", "Owl", "Firefly", "Chicken Zombie", ["Blood Kiwi"] = 2, ["Capybara"] = 4, ["Starfish"] = 2, ["Rooster"] = 5, ["Sunny-Side Chicken"] = 20 },
    KEEP_PETS_WEIGHT = 7,

    EQUIP_PETS = { ["Sunny-Side Chicken"] = 5, ["Starfish"] = 2, ["Capybara"] = 1 },
    ...
    SEED_WEBHOOK_URL = "", 
    NOTIFY_PETS = { "Gnome", "Griffin", "Golden Goose", "Gorilla Chef", "Lobster Thermidor", "French Fry Ferret", "Mochi Mouse", "Corrupted Kitsune", "Raiju", "Mizuchi", "Bald Eagle", "Koi", "Kitsune", "Fennec Fox", "Disco Bee", "Raccoon", "Queen Bee", "Night Owl", "Dragonfly", "Butterfly", "Mimic Octopus", "Red Fox", "Brontosaurus", "T-Rex", "Ankylosaurus", "Spinosaurus" },
